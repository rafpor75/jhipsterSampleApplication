...
public class DocentiResource {
    ...
    @Timed
    public ResponseEntity<DocentiDTO> createDocenti(@RequestBody DocentiDTO docentiDTO) throws URISyntaxException {
    ...
    @PutMapping("/docentis")
    @Timed
    public ResponseEntity<DocentiDTO> updateDocenti(@RequestBody DocentiDTO docentiDTO) throws URISyntaxException {
