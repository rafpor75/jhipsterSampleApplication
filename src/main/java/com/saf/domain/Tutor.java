...
public class Tutor implements Serializable {
    ...
    public Tutor addRelTutMat(Materie materie) {
        this.relTutMats.add(materie);
        materie.setRelMatTut(this);
        return this;
    }

    public Tutor removeRelTutMat(Materie materie) {
        this.relTutMats.remove(materie);
        materie.setRelMatTut(null);
        return this;
    }
