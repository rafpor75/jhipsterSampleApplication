...
public class AnnoAccademicoResource {
    ...
    @Timed
    public ResponseEntity<AnnoAccademicoDTO> createAnnoAccademico(@RequestBody AnnoAccademicoDTO annoAccademicoDTO) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<AnnoAccademicoDTO> updateAnnoAccademico(@RequestBody AnnoAccademicoDTO annoAccademicoDTO) throws URISyntaxException {
