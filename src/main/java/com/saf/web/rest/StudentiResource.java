...
public class StudentiResource {
    ...
    @Timed
    public ResponseEntity<StudentiDTO> createStudenti(@RequestBody StudentiDTO studentiDTO) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<StudentiDTO> updateStudenti(@RequestBody StudentiDTO studentiDTO) throws URISyntaxException {
