...
public class CdlResource {
    ...
    @PostMapping("/cdls")
    @Timed
    public ResponseEntity<CdlDTO> createCdl(@RequestBody CdlDTO cdlDTO) throws URISyntaxException {
    ...
    @PutMapping("/cdls")
    @Timed
    public ResponseEntity<CdlDTO> updateCdl(@RequestBody CdlDTO cdlDTO) throws URISyntaxException {
