...
public class MaterieResource {
    ...
    @Timed
    public ResponseEntity<MaterieDTO> createMaterie(@RequestBody MaterieDTO materieDTO) throws URISyntaxException {
    ...
    @PutMapping("/materies")
    @Timed
    public ResponseEntity<MaterieDTO> updateMaterie(@RequestBody MaterieDTO materieDTO) throws URISyntaxException {
