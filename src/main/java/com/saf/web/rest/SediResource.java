...
public class SediResource {
    ...
    @PostMapping("/sedis")
    @Timed
    public ResponseEntity<SediDTO> createSedi(@RequestBody SediDTO sediDTO) throws URISyntaxException {
    ...
    @PutMapping("/sedis")
    @Timed
    public ResponseEntity<SediDTO> updateSedi(@RequestBody SediDTO sediDTO) throws URISyntaxException {
